          ...
          {tab === 'chatbot' ? (
            <div className="space-y-6 animate-fade-in">
              ...
              <p className="text-sm md:text-base font-mono text-primary/70 leading-relaxed">
                Just chat with the AskRei Chatbot and she finds bounties that match your skills. The
                better your Diamond Hand Score, the more hidden bounties you can see.
              </p>
              ...
              <button className="btn-manga btn-manga-primary px-8 py-3 mt-4" onClick={() => (window.location.href = '/rei')}>
                Signup
              </button>
            </div>
          ) : (
