...
export const HomeVideoDemo = () => {
  ...
  return (
    <section className="min-h-screen snap-start relative flex flex-col items-center justify-center bg-[#0a0a0a] p-6 md:p-12">
      ...
      <div className="w-full max-w-5xl aspect-video relative rounded-lg overflow-hidden border-4 border-cream shadow-2xl bg-[#0a0a0a]">
        {isLoading && (
          <div className="absolute inset-0 z-10 flex items-center justify-center bg-[#0a0a0a]">
            <div className="h-12 w-12 rounded-full border-4 border-cream/20 border-t-cream animate-spin" />
          </div>
        )}
        <iframe
